...
--UtilityManagerADND.logDebug("char_matrix_thaco.lua","onInit","node",node);      
  local bisPC = (ActorManager.isPC(node)); 
--UtilityManagerADND.logDebug("char_matrix_thaco.lua","onInit","bisPC",bisPC);      
  local bUseMatrix = (DataCommonADND.coreVersion == "1e");
--UtilityManagerADND.logDebug("char_matrix_thaco.lua","onInit","bUseMatrix1",bUseMatrix);    
  if bUseMatrix then
...
function createTHACOMatrix()
  ...
  local bisPC = (ActorManager.isPC(node)); 
  local bUseMatrix = (DataCommonADND.coreVersion == "1e");
--UtilityManagerADND.logDebug("char_matrix_thaco.lua","createTHACOMatrix","node",node);
...
function update()
  local node = getDatabaseNode();
--UtilityManagerADND.logDebug("char_matrix_thaco.lua","update","node",node);
  local bisPC = (ActorManager.isPC(node)); 
--UtilityManagerADND.logDebug("char_matrix_thaco.lua","createTHACOMatrix","node",node);
