...
function onIDChanged(nodeField)
  ...
  if (DB.getValue(nodeItem, "carried", 0) == 2) and (ItemManager2.isArmor(nodeItem) or ItemManager2.isWarding(nodeItem) or ItemManager2.isProtectionOther(nodeItem)) then
...
--UtilityManagerADND.logDebug("char_invlist.lua","onCarriedChanged","nodeField",nodeField);
  ...
  if nodeChar then
    local nodeItem = DB.getChild(nodeField, "..");
		...
		if (ItemManager2.isArmor(nodeItem) or ItemManager2.isWarding(nodeItem) or ItemManager2.isProtectionOther(nodeItem)) then
...
--UtilityManagerADND.logDebug("char_invlist.lua","onDrop","draginfo1",draginfo);  
