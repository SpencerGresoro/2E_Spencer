...
function onTokenAdded(tokenCT)
-- UtilityManagerADND.logDebug("image_control.lua","onTokenAdded","tokenCT",tokenCT);    
...
--   UtilityManagerADND.logDebug("image_control.lua","onUnitSizeUpdates","node",node);
