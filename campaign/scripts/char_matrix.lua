...
--UtilityManagerADND.logDebug("char_matrix.lua","createAttackMatrix","node",node);    
...
--UtilityManagerADND.logDebug("char_matrix.lua","createAttackMatrix","aMatrixRolls",aMatrixRolls);              
    end
  end
  --
