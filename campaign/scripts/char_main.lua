...
function onEncumbranceChanged(nodeElement)
  ...
  -- --UtilityManagerADND.logDebug("manager_char.lua","---------onEncumbranceChanged---------","nodeChar",nodeChar);
...
function updatesBulk(nodeCT)
  --UtilityManagerADND.logDebug("manager_char.lua","---------updatesBulk---------","nodeCT",nodeCT);
...
function updateAbilityScores(node)
  ...
  -- UtilityManagerADND.logDebug("char_main.lua","---------updateAbilityScores---------","nodeChar",nodeChar);
