...
function getRoll(rActor, nodeSkill, nTargetDC, bSecretRoll)
  ...
  local nMod, bADV, bDIS, sAddText = ActorManagerADND.getCheck(rActor, sAbility:lower(), sSkill);
  rRoll.nMod = nMod;
...
function getUnlistedRoll(rActor, sSkill, nTargetDC, bSecretRoll)
  ...
  if sAbility then
    nMod, bADV, bDIS, sAddText = ActorManagerADND.getCheck(rActor, sAbility, sSkill);
  end
...
function modRoll(rSource, rTarget, rRoll)
  ...
  if rSource then
    ...
    -- local nBonusStat, nBonusEffects = ActorManagerADND.getAbilityEffectsBonus(rSource, sAbility);
