...
--UtilityManagerADND.logDebug("manager_abilityscores.lua","getStrengthProperties","nodeChar",nodeChar);
--UtilityManagerADND.logDebug("manager_abilityscores.lua","getStrengthProperties","rActor",rActor);
    if rActor then
        ...
        if (nAbilityMod ~= 0) then
         nScore = nAbilityMod;
--UtilityManagerADND.logDebug("manager_abilityscores.lua","getStrengthProperties","nAbilityMod",nAbilityMod);         
        end
...
--UtilityManagerADND.logDebug("manager_abilityscores.lua","getStrengthProperties","dbAbility",dbAbility);
    return dbAbility;
end
...
--UtilityManagerADND.logDebug("manager_abilityscores.lua","getDexterityProperties","nodeChar",nodeChar);
--UtilityManagerADND.logDebug("manager_abilityscores.lua","getDexterityProperties","nScore",nScore);

    local rActor = ActorManager.resolveActor( nodeChar);
--UtilityManagerADND.logDebug("manager_abilityscores.lua","getDexterityProperties","rActor------>",rActor);
    if rActor then
        -- adjust ability scores from effects!
...
--UtilityManagerADND.logDebug("manager_abilityscores.lua","getDexterityProperties","nAbilityMod1------>",nAbilityMod);
--UtilityManagerADND.logDebug("manager_abilityscores.lua","getDexterityProperties","nAbilityEffects1------->",nAbilityEffects);
        
        sAbilityEffect = "DEX";
        nAbilityMod, nAbilityEffects = EffectManager5E.getEffectsBonus(rActor, sAbilityEffect, true);
        nScore = nScore + nAbilityMod;
--UtilityManagerADND.logDebug("manager_abilityscores.lua","getDexterityProperties","nAbilityMod2------>",nAbilityMod);
--UtilityManagerADND.logDebug("manager_abilityscores.lua","getDexterityProperties","nAbilityEffects2------->",nAbilityEffects);
--UtilityManagerADND.logDebug("manager_abilityscores.lua","getDexterityProperties","ONE",nScore);
    end
--UtilityManagerADND.logDebug("manager_abilityscores.lua","getDexterityProperties","TWO",nScore);
    nScore = abilityScoreSanity(nScore);
    local dbAbility = {};
...
--UtilityManagerADND.logDebug("manager_abilityscores.lua","getDexterityProperties","dbAbility",dbAbility);
    return dbAbility;
end
...
--UtilityManagerADND.logDebug("manager_abilityscores.lua","getWisdomProperties","dbAbility",dbAbility);
    return dbAbility;
end
...
--UtilityManagerADND.logDebug("manager_abilityscores.lua","getConstitutionProperties","dbAbility",dbAbility);
    return dbAbility;
end
...
--UtilityManagerADND.logDebug("manager_abilityscores.lua","getCharismaProperties","dbAbility",dbAbility);
    return dbAbility;
end
...
--UtilityManagerADND.logDebug("manager_abilityscores.lua","getIntelligenceProperties","dbAbility",dbAbility);
    return dbAbility;
end
...
--UtilityManagerADND.logDebug("manager_abilityscores.lua","updateStrength","nodeChar",nodeChar);
...
function updateForEffects(nodeChar)
    ...
    -- if not UtilityManagerADND.rateLimitOK(updateForEffects,nodeChar,1) then
    --     return;
    -- end
--UtilityManagerADND.logDebug("manager_abilityscores.lua","updateForEffects","nodeChar",nodeChar);
...
function detailsUpdate(nodeChar)
    -- if not UtilityManagerADND.rateLimitOK(detailsUpdate,nodeChar,1) then
    --     return;
    -- end
--UtilityManagerADND.logDebug("char_abilities_details.lua",">---detailsUpdate---<","nodeChar",nodeChar);
  for i = 1,6,1 do
    local sTarget = DataCommon.abilities[i];
--UtilityManagerADND.logDebug("char_abilities_details.lua",">---detailsUpdate---<","sTarget",sTarget);    
    ...
    -- UtilityManagerADND.logDebug("char_abilities_details.lua",">---detailsUpdate---<","nScoreCurrent",nScoreCurrent);
    --UtilityManagerADND.logDebug("char_abilities_details.lua",">---detailsUpdate---<","nTotalCurrent",nTotalCurrent);
    -- UtilityManagerADND.logDebug("char_abilities_details.lua",">---detailsUpdate---<","nTotal",nTotal);    
...
function detailsPercentUpdate(nodeChar)
    -- if not UtilityManagerADND.rateLimitOK(detailsPercentUpdate,nodeChar,1) then
    --     return;
    -- end
  for i = 1,6,1 do
    local sTarget = DataCommon.abilities[i];
